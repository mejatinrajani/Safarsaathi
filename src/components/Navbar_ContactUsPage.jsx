...
function Navbar_HomePage() {
  ...
  return (
    <div>
      <nav className="bg-white opacity-100 shadow-lg rounded-[100px] mx-4 my-4 flex items-center justify-between px-6 py-2">
        ...
        <div className="hidden lg:flex space-x-6">
          ...
          <Link
            to="/contact"
            className="text-black font-semibold relative scale-110 transition-all nav-link"
          >
            <span className="text-3xl ">Contact Us</span>
            <span className="absolute bg-green-500 inset-0 blur-md rounded-lg opacity-50"></span>
          </Link>
        </div>
